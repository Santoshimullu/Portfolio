function newt(){
    ...
    let newnode=document.createElement("textarea"); //element type like input, textarea
    newnode.classList.add('form-control');    //bootstrap css
    newnode.classList.add('first');           // specify the class name because the newnode you are creating comes through that classname      
...
function pagepgg(){
    ...
    let pp=document.getElementsByClassName("first");            // call the specify class name you have given
    let str= "";
